...
\newpage
![](../ms_figs/observed_v_predicted.png){ width=100% }
**Figure 2: Observed vs. model-predicted values for per-capita growth rate and annual number of burrows counted.** Includes predicted values for missing growth rates for 2005-06 and number of burrows counted in 2006, as well as predictions for 2021.
\clearpage

\newpage
![](../ms_figs/effect_size.png){ width=100% }
**Figure 2: Partial effects plots for each covariate.**
\clearpage
